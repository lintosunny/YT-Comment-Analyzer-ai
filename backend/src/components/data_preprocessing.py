...
def main():
    try:
        ...
        train_data = pd.read_csv('./backend/data/raw/train.csv')
        test_data = pd.read_csv('./backend/data/raw/test.csv')
        ...
        save_data(train_processed_data, test_processed_data, data_path='./backend/data')
    except Exception as e:
