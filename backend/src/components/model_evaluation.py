...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            vectorizer = load_vectorizer(os.path.join(root_dir, 'model/tfidf_vectorizer.pkl'))
            ...
            save_model_info(run.info.run_id, model_path, 'backend/model/experiment_info.json')
